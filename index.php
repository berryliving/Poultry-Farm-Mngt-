...
<body class="home">
        ...
        <section class="hero bg-image" data-image-src="images/img/pi.jpg">
                ...
                <div class="container text-center hero-text font-white">
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span style="color:white;">1. </span>Choose Farm</h4> </div>
                        ...
                        <div class="step-item step2">
                            ...
                            <h4><span style="color:white;">2. </span>Order Poultry</h4> </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Popular Poultry of the Month</h2>
                    <p class="lead">Easiest way to order your your Poultry</p>
                </div>
                <div class="row">
						<?php 					
						$query_res= mysqli_query($db,"select * from poultry LIMIT 6"); 
                                while($r=mysqli_fetch_array($query_res))
                                {
                                    ...
                                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                ...
                                                <div class="content">
                                                    <h5><a href="poultry.php?res_id='.$r['farm_id'].'">'.$r['title'].'</a></h5>
                                                    <div class="product-name">'.$r['slogan'].'</div>
                                                    <div class="price-btn-block"> <span class="price">Tsh.'.$r['price'].'</span> <a href="poultry.php?res_id='.$r['farm_id'].'" class="btn theme-btn-dash pull-right">Order Now</a> </div>
                                                </div>
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <h3>Choose a Nearest Farm</h3>
                                    <p>We"ve got your covered with products from a variety of delivery Farms online.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <p>Get your poultry product! and enjoy our Services </p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-4">
                        <div class="title-block pull-left">
                            <h4>Featured Poultry Farms</h4> </div>
                    </div>
                    <div class="col-sm-8">
                        <div class="restaurants-filter pull-right">
                            <nav class="primary pull-left">
                                <ul>
									...
									<?php 
									$res= mysqli_query($db,"select * from farm_category");
                ...
                <div class="row">
                    <div class="restaurant-listing">
						...
						<?php  
						$ress= mysqli_query($db,"select * from farm");  
									      while($rows=mysqli_fetch_array($ress))
										  {
													
													$query= mysqli_query($db,"select * from farm_category where c_id='".$rows['c_id']."' ");
														...
														<div class="restaurant-wrap">
															<div class="row">
																<div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
																	<a class="restaurant-logo" href="poultry.php?res_id='.$rows['farm_id'].'" > <img src="admin/Res_img/'.$rows['image'].'" alt="LOGO"> </a>
																</div>
													
																<div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
																	<h5><a href="poultry.php?res_id='.$rows['farm_id'].'" >'.$rows['title'].'</a></h5> <span>'.$rows['address'].'</span>
																</div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-3 payment-options color-gray">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="#"> <img src="images/mastercard.png" alt="Mastercard"> Cash on Delivery </a>
                                </li>
                                <!-- <li>
